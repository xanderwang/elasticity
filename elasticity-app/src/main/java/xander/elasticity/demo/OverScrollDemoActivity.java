package xander.elasticity.demo;
...
import xander.elasticity.demo.view.GridViewDemoFragment;
import xander.elasticity.demo.view.ListViewDemoFragment;
import xander.elasticity.demo.view.MiscViewsDemoFragment;
import xander.elasticity.demo.view.RecyclerViewDemoFragment;
import xander.elasticity.demo.view.RecyclerViewStaggeredGridDemoFragment;
import xander.elasticity.demo.view.ScrollViewDemoFragment;
import xander.elasticity.demo.view.ViewPagerDemoFragment;
...
public class OverScrollDemoActivity extends AppCompatActivity
    ...
    public void viewSource( View view ) {
        ...
        Uri sourceUrl = Uri.parse("https://github.com/XanderWang/Xander-Elasticity");
        viewSource.setData(sourceUrl);
