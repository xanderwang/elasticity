...
import static xander.elasticity.HorizontalElasticityBounceEffect.DEFAULT_DECELERATE_FACTOR;
import static xander.elasticity.HorizontalElasticityBounceEffect.DEFAULT_TOUCH_DRAG_MOVE_RATIO_FWD;
...
public class HorizontalElasticityBounceEffectTest {
    ...
    protected HorizontalElasticityBounceEffect getUUT() {
        HorizontalElasticityBounceEffect uut = new HorizontalElasticityBounceEffect(mViewAdapter);
    ...
    protected HorizontalElasticityBounceEffect getUUT(float touchDragRatioFwd, float touchDragRatioBck) {
        HorizontalElasticityBounceEffect uut = new HorizontalElasticityBounceEffect(mViewAdapter, touchDragRatioFwd, touchDragRatioBck, DEFAULT_DECELERATE_FACTOR);
        uut.setOverScrollStateListener(mStateListener);
        uut.setOverScrollUpdateListener(mUpdateListener);
        return uut;
    }
