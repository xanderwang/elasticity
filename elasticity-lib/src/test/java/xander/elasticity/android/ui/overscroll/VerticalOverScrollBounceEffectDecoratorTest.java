package xander.elasticity.android.ui.overscroll;
...
import static xander.elasticity.VerticalElasticityBounceEffect.DEFAULT_DECELERATE_FACTOR;
import static xander.elasticity.VerticalElasticityBounceEffect.DEFAULT_TOUCH_DRAG_MOVE_RATIO_FWD;
...
public class VerticalOverScrollBounceEffectDecoratorTest {
    ...
    View mView;
    IElasticityAdapter mViewAdapter;
    IElasticityStateListener mStateListener;
    IElasticityUpdateListener mUpdateListener;

    @Before
    public void setUp() throws Exception {
        mView = mock(View.class);
        mViewAdapter = mock(IElasticityAdapter.class);
        when(mViewAdapter.getView()).thenReturn(mView);

        mStateListener = mock(IElasticityStateListener.class);
        mUpdateListener = mock(IElasticityUpdateListener.class);
    }
    ...
    public void detach_decoratorIsAttached_detachFromView() throws Exception {
        ...
        HorizontalElasticityBounceEffect uut = new HorizontalElasticityBounceEffect(mViewAdapter);
    ...
    public void onTouchMoveAction_dragUpWhenDownOverscolled_continueOverscrollingUpwards() throws Exception {
        ...
        VerticalElasticityBounceEffect uut = getUUT(touchDragRatioFwd, touchDragRatioBck);
    ...
    protected VerticalElasticityBounceEffect getUUT() {
        VerticalElasticityBounceEffect uut = new VerticalElasticityBounceEffect(mViewAdapter);
        uut.setOverScrollStateListener(mStateListener);
        uut.setOverScrollUpdateListener(mUpdateListener);
        return uut;
    }

    protected VerticalElasticityBounceEffect getUUT(float touchDragRatioFwd, float touchDragRatioBck) {
        VerticalElasticityBounceEffect uut = new VerticalElasticityBounceEffect(mViewAdapter, touchDragRatioFwd, touchDragRatioBck, DEFAULT_DECELERATE_FACTOR);
        uut.setOverScrollStateListener(mStateListener);
        uut.setOverScrollUpdateListener(mUpdateListener);
        return uut;
    }
